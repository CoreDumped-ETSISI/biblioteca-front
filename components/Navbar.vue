    ...
    <nav :style="{
      ...
      <div class="links">
        ...
        <div id="logged" v-if="logged">
          <div id="searchbox">
            <input placeholder="Busca un libro..." type="text" name="search" id="search" />
            <div class="filters">
              ...
              <div class="add">
                <div class="params-container">
                  ...
                  <div class="params">
                    <div @click="toggleParam(param)" :style="{ background: param.active ? '#0d860f' : '#0d860fb3' }"
                      class="param" v-bind:key="param.key" v-for="param of this.params">
                      <div class="key">
                        {{ param.key }}
                      </div>
              ...
              <div class="tags" v-for="param of params" v-bind:key="param.key">
                <div class="tag" v-if="param.active">{{ param.key }} <i @click="toggleParam(param)" class="material-icons">
                    close
                  </i> </div>
              </div>
            </div>
          </div>
          <div class="btn-user" @click="signout">
            <i class="material-icons">
              person
            </i>
          </div>
